    ...
    std::vector<glm::vec4>& offsets)
{
    ...
    return this->LoadModelIntoVAO(drawInfo, shaderProgramID, offsets);
}
...
bool cVAOManager::LoadModelIntoVAO(sModelDrawInfo& drawInfo, unsigned int shaderProgramID, std::vector<glm::vec4>& offsets)
{
