...
bool cMapLoader::LoadMap(std::string decorationMapFileName, std::string collisionMapFileName, std::string& errorString)
{
    // Load decoration
    {
        ...
        if (decFile == NULL)
        {
            errorString = "Decoration map doesn't exist...";
            return false;
        }
    ...
    // Load collision
    {
        ...
        if (colFile == NULL)
        {
            errorString = "Collision map doesn't exist...";
            return false;
        }
        ...
        {
            errorString = "Decoration and collision map sizes don't match";
            fclose(colFile);
            return false;
        }
